...
# 2. تنسيق الصفحة باللون الرملي وخلفية التعدين (تم تصحيح المعامل البرمجي)
st.markdown("""
<style>
    /* خلفية التطبيق متدرجة باللون الرملي مع صورة تعدين */
    .stApp {
    ...
    /* نصوص الترويسات باللون البني الصحراوي */
    h1, h2, h3, h4, h5, h6 {
    ...
    /* إبراز المربعات والبطاقات خلفية شبه شفافة */
